...
import { getCoinSupply, getHalving } from '../BTCD-api-client';
...
const CBox = () => {
    ...
    async function getBlockReward() {
        await fetch('https://api.BTCDcoin.com/info/blockreward')
            ...
            <table style={{ fontSize: "1rem" }}>
                ...
                <tr>
                    <td className="cardBoxElement align-top">
                        Total</td>
                    <td className="">
                        <div id="coins">{numberWithCommas(circCoins)} BTCD
                        </div>
                    </td>
                </tr>
                <tr>
                    <td className="cardBoxElement align-top">Max <span className="approx">(approx.)</span></td>
                    <td className="pt-1">4,961,000,000 BTCD</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td className="pt-1">{blockReward} BTCD</td>
                </tr>
                <tr>
                    ...
                    <td className="pt-1">{halvingDate}<br /><div className="text-end w-100 pe-3 pt-1" style={{ fontSize: "small" }}>to {halvingAmount} BTCD</div></td>
                </tr>
            </table>
        </div>
    </>
